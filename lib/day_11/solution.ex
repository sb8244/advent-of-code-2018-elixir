defmodule Advent.Day11.Solution do
  def solve(serial) do
    Enum.reduce((1..300), {-100000, nil}, fn x, acc ->
  ...
  def solve_arbitrary(serial) do
    Enum.reduce((8..20), {-100000, nil}, fn n_size, acc ->
  ...
  def three_by_three(x, y, _) when x >= 298 or y >= 298, do: -100000
  ...
  def n_by_n(n, x, y, _) when x+n > 301 or y + n >= 301, do: -100000
